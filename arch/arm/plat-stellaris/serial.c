...
#elif defined(CONFIG_STELLARIS_EARLY_CONSOLE_UART3)
#define EARLY_CONSOLE_BASE STLR_UART3_BASE
#elif defined(CONFIG_STELLARIS_EARLY_CONSOLE_UART4)
#define EARLY_CONSOLE_BASE STLR_UART4_BASE
#elif defined(CONFIG_STELLARIS_EARLY_CONSOLE_UART5)
#define EARLY_CONSOLE_BASE STLR_UART5_BASE
#elif defined(CONFIG_STELLARIS_EARLY_CONSOLE_UART6)
#define EARLY_CONSOLE_BASE STLR_UART6_BASE
#elif defined(CONFIG_STELLARIS_EARLY_CONSOLE_UART7)
#define EARLY_CONSOLE_BASE STLR_UART7_BASE
#endif
