...
#else
#define GPIO_SSI_CS_RF   (GPIO_FUNC_OUTPUT    | GPIO_PORTF | 2 | GPIO_VALUE_ONE)    /* PA6: SSI0 RF chip select */
#endif
#define GPIO_SSI_CS_ETH  (GPIO_FUNC_OUTPUT    | GPIO_PORTB | 4 | GPIO_VALUE_ONE)    /* Use SSI1 Fss signal instead of CS */

#define GPIO_RF_NRDY     (GPIO_FUNC_ODINPUT   | GPIO_PORTD | 6 | GPIO_PADTYPE_STDWPU)
#define GPIO_RF_NRST     (GPIO_FUNC_OUTPUT    | GPIO_PORTB | 2 | GPIO_VALUE_ZERO)

#define GPIO_ETH_INTRN   (GPIO_FUNC_INTERRUPT | GPIO_PORTF | 1 | GPIO_INT_LOWLEVEL)/* PG5: ETH chip interrupt */
#define GPIO_RF_INTRN    (GPIO_FUNC_INTERRUPT | GPIO_PORTE | 6 | GPIO_INT_LOWLEVEL | GPIO_PADTYPE_STDWPU)/* PG5: RF modem interrupt */
